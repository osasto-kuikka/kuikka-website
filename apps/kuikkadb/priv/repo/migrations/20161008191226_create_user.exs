defmodule KuikkaDB.Repo.Migrations.CreateUser do
    ...
    This table is created for a registered users in webpage. parameters are:
         ...
         - signature 250 char long text to use in forums and profile page as your signature
         
    username, password and email are mantadory and username and email must be unique.
